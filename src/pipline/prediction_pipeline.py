...
class VehicleData:
    def __init__(self,
        ...
        Input: all feature of the trained model for prediction
        """
        try:
            self.Gender = Gender
            self.Age = Age
...
class VehicleDataClassifier:
    def __init__ (self, prediction_pipeline_config: VehiclePredictorConfig = VehiclePredictorConfig() , ) ->None:
        """
        :param prediction_pipeline_config: Configuration from prediction for prediction the value
        """
    ...
    def predict(self,dataframe) ->str:
        """
        This is the method of VehcleDataClassifier
        """
        try:
            logging.info("Enter predict method of VecleDataClassifier class")
