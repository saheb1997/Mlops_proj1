...
class ModelTrainer:
    ...
    def get_model_object_and_report(self, train: np.array ,test :np .array) -> Tuple [object ,object]:
        ...
        try:
            ...
            logging.info("Model object created successfully")
            model.fit(x_train,y_train)
            logging.info("Model trained successfully")

            #predction and evaluation metrics
            ...
            #creating the metric artifact object
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        try:
            print("-------------------------------------------")
            print("starting Model Traner component")
            ...
            logging.info("Model trained and metrics calculated successfully")
