...
#intialize FastApi application
app = FastAPI()

#Mount the 'static' derectory fro serving static files (like CSS)
...
#Allow all origins for cross_origin Resoucre sharing (Cros)
origins =  ["*"]

#configure middleware to handel Cors, allowing request from any origin
app.add_middleware(
    CORSMiddleware,
...
#Route to rener the main page with the form 
@app.get("/",tags=["authentication"])

async def index(request: Request):
    """
    Render the main HTML from page for vehicle data input
    """
...
async def trainRouteClient():
    """
    Endpoint to initiate the model traning pipeline
    """
    try:
...
async def predictRouteClient(request :Request):
    ...
    try:
        ...
        #Render the same HTML page the prediction result
